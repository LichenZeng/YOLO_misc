...
class Detect:
    ...
    def __init__(self, img):
        # 初始化参数
        self.net = Yolo_V2()
        self.net_param = r"my_param/yolo_v2_test_100.pkl"
    ...
    def detect(self):
        ...
        for i in range(len(index_nonzero_np)):
            ...
            [x1, y1, x2, y2] = self.reverse_boxes(c, h, w, out_offset_np[0][c][h][w][0], out_offset_np[0][c][h][w][1],
                                                  out_offset_np[0][c][h][w][2], out_offset_np[0][c][h][w][3])

...
class gen_Data:
    def __init__(self, xml_path, img_path, save_img_224_path, save_txt):
        ...
        print(len(self.xml_list))
        self.xml_list = self.xml_list[:15]
        print(len(self.xml_list))
            ...
            try:
                ...
                try:
                    ...
                    for obj in root.iter("object"):
                        ...
                        # 计算偏移值
                        max_box = np.array(
                            [boxes[index_max][0], boxes[index_max][1], boxes[index_max][2], boxes[index_max][3]])
                    ...
                    for num in range(len(list_type)):
                        str += "*{0},{1},{2},{3},{4},{5},{6},{7}".format(list_type[num], list_heigth[num],
                                                                         list_width[num], list_channel[num],
                                                                         list_offset[num][0], list_offset[num][1],
                                                                         list_offset[num][2], list_offset[num][3])
